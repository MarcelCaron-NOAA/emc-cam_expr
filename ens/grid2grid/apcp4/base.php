...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">RRFS Ensemble: Precipitation FSS (Threshold mean)</a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/cam/expr/ens/images/precip/evs.rrfsens_LLL.MMMFFF.TTT.DDD.PPP_valid_HHH.RRR.png";
...
forecasthours.push({
        displayName: "1x1 grid",
	name: ".width1",
});
forecasthours.push({
        displayName: "3x3 grids",
        name: ".width3",
});
forecasthours.push({
        displayName: "5x5 grids",
        name: ".width5",
});
forecasthours.push({
        displayName: "7x7 grids" ,
        name: ".width7",
});
forecasthours.push({
        displayName: "9x9 grids",
        name: ".width9",
});
forecasthours.push({
        displayName: "11x11 grids",
        name: ".width11",
});
forecasthours.push({
        displayName: "Avergae",
...
threshmean_forecasthours = [".width1"]
