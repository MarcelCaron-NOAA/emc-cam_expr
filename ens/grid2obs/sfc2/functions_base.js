...
function changePlotType(id){
	...
	else if(selected_plottype=="performance"){
                plottype_forecasthours = performance_forecasthours;
        }
	...
	forecasthours = [];
	   ...
	   if( (selected_plottype=="fhrmean") || (selected_plottype=="leaddate") || (selected_plottype=="fhrmean")) {
                forecasthours.push({
