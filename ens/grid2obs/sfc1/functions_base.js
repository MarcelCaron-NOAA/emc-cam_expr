...
function changePlotType(id){
	...
	else if(selected_plottype=="relposition"){
                plottype_metrics = relposition_metrics;
                plottype_metrics_name = relposition_metrics_name;
        }
	else if(selected_plottype=="rankhistogram"){
                plottype_metrics = rankhistogram_metrics;
                plottype_metrics_name = rankhistogram_metrics_name;
        }
	metrics = [];
