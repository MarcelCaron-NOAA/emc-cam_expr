...
<head>
<meta charset="UTF-8">
<title>RRFS Ensemble Atmospheric Verification - Parallel - G2O: CAPE</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">RRFS Ensemble: CAPE (Threshold mean)</a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/cam/expr/ens/images/cape/evs.rrfsens.MMM.TTT.DDD.PPP_valid_HHH.FFF.RRR.png";
...
threshmean_forecasthours = ["f06", "f12", "f18", "f24", "f30", "f36", "f42", "f48"]
