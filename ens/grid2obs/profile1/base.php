...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">RRFS Ensemble Individual Members: Profile Verification</a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/cam/expr/ens/images/member/evs.rrfsens.MMM.TTT.DDD.PPP_valid_HHH_fFFF.RRR.png";
...
profile_forecasthours = ["12", "18", "24", "30", "36", "42", "48"]
hawaii_forecasthours = ["12", "24", "36", "48"]
alaska_forecasthours = [ "18", "30", "42"]
prico_forecasthours = [ "18", "30", "42"]
