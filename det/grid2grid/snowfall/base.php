...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/cam/expr/det/grid2grid/images/evs.cam.MMMTTTVVV_LLL.DDD.PPP_initHHHz_FFF.RRR.png";
...
derivedvars.push({
	displayName: "Snow Depth/Accum. Snow",
	name: "asnow",
});
derivedvars.push({
...
z00_12_weasd_levels = ["06_a06", "24_a24"]
z00_12_weasd_levels_name = ["6-hour", "24-hour"]
z06_18_asnow_levels = ["a24"]
z06_18_asnow_levels_name = ["24-hour"]
z06_18_weasd_levels = ["24_a24"]
z06_18_weasd_levels_name = ["24-hour"]
accum06_forecasthours = ["f024-f048", "f036-f060"]
z00_12_accum24_forecasthours = ["f024", "f036", "f048", "f060"]
z06_18_accum24_forecasthours = ["f030", "f042", "f054"]
